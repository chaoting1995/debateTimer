import { DEFAULT_WALLES, DT_LOCALSTORAGE_KEY_WALLES } from 'modules/walle/resources/walle.constant';
...
const getWalles = (): Walle[] => {
  ...
  if (!jsonString) return JSON.parse(JSON.stringify(DEFAULT_WALLES));
